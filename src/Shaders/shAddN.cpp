...
shAddN::shAddN(const shBase* mt0, const shBase* mt1 /*= NULL*/, const shBase* mt2 /*= NULL*/, const shBase* mt3 /*= NULL*/, const shBase* mt4 /*= NULL*/, const shBase* mt5 /*= NULL*/, const shBase* mt6 /*= NULL*/, const shBase* mt7 /*= NULL*/, const shBase* mt8 /*= NULL*/, const shBase* mt9 /*= NULL */) {
...
void shAddN::Shade (const Ray &r, rgba* result) const {
	*result = rgba(0);
	rgba r2;
